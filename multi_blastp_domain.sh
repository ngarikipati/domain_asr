...
do
        ...
        nice blastp -query ${SEQ} -task blastp -db /mnt/data2/blast/refseq_protein -out ${SEQ%.txt}dump.txt -evalue 0.01 -word_size 6 -gapopen 11 -gapextend 1 -matrix BLOSUM62 -outfmt "10 delim=| saccver stitle sseq" -max_target_seqs 10000 -num_threads 28
done
